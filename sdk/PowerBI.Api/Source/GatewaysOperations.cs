...
namespace Microsoft.PowerBI.Api.V1
{
    ...
    /// </summary>
    internal partial class GatewaysOperations : IServiceOperations<PowerBIClient>, IGatewaysOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal GatewaysOperations(PowerBIClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<object>> PatchDatasourceWithHttpMessagesAsync(string collectionName, string workspaceId, string gatewayId, string datasourceId, object datasourceDelta, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
