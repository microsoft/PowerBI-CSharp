...
namespace Microsoft.PowerBI.Api.V1
{
    ...
    public static partial class GatewaysOperationsExtensions
    {
            ...
            /// </param>
            public static object PatchDatasource(this IGatewaysOperations operations, string collectionName, string workspaceId, string gatewayId, string datasourceId, object datasourceDelta)
            {
            ...
            /// </param>
            public static async Task<object> PatchDatasourceAsync(this IGatewaysOperations operations, string collectionName, string workspaceId, string gatewayId, string datasourceId, object datasourceDelta, CancellationToken cancellationToken = default(CancellationToken))
            {
