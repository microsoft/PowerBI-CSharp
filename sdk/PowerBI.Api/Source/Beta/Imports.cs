...
namespace Microsoft.PowerBI.Api.Beta
{
    ...
    public partial class Imports : IServiceOperations<PowerBIClient>, IImports
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<ODataResponseListImport>> GetImportsByGroupWithHttpMessagesAsync(string group, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (group == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetImportsByGroup", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
