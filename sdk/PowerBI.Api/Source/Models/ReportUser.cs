...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    public partial class ReportUser
    {
        ...
        public ReportUser(ReportUserAccessRight reportUserAccessRight, string emailAddress = default(string), string displayName = default(string), string identifier = default(string), string graphId = default(string), PrincipalType? principalType = default(PrincipalType?))
        {
