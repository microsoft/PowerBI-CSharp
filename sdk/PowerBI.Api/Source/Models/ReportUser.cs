...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    public partial class ReportUser : User
    {
        ...
        public ReportUser(string emailAddress, string identifier, PrincipalType principalType, ReportUserAccessRight reportUserAccessRight, string displayName = default(string), string graphId = default(string))
