...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    /// </summary>
    public partial class AdminTile
    {
        /// <summary>
        /// Initializes a new instance of the AdminTile class.
        /// </summary>
        public AdminTile()
        {
            CustomInit();
        ...
        public AdminTile(System.Guid id, string title = default(string), System.Guid? reportId = default(System.Guid?), string datasetId = default(string), int? rowSpan = default(int?), int? colSpan = default(int?), string embedUrl = default(string), string embedData = default(string))
        {
            Id = id;
            Title = title;
            ReportId = reportId;
