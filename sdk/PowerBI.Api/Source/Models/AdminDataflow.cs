...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    public partial class AdminDataflow
    {
        ...
        public AdminDataflow(System.Guid objectId, string name = default(string), string description = default(string), string modelUrl = default(string), string configuredBy = default(string), IList<DataflowUser> users = default(IList<DataflowUser>), System.Guid? workspaceId = default(System.Guid?))
        {
            ObjectId = objectId;
            Name = name;
