...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    public partial class DataflowBaseProperties
    {
        ...
        public DataflowBaseProperties(System.Guid objectId, string name = default(string), string description = default(string), string modelUrl = default(string), string configuredBy = default(string), IList<DataflowUser> users = default(IList<DataflowUser>))
        {
            ObjectId = objectId;
            Name = name;
