...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    /// <summary>
    /// A Power BI dataset returned by Admin APIs. The API returns a subset of
    /// the following list of dataset properties. The subset depends on the API
    /// called, caller permissions, and the availability of the data in the
    /// Power BI database.
    /// </summary>
    public partial class AdminDataset
    {
        /// <summary>
        /// Initializes a new instance of the AdminDataset class.
        /// </summary>
        public AdminDataset()
        {
            CustomInit();
