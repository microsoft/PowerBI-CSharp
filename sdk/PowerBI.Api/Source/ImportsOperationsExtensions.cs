...
namespace Microsoft.PowerBI.Api.V1
{
    ...
    public static partial class ImportsOperationsExtensions
    {
            ...
            /// The workspace id
            /// </param>
            public static ODataResponseListImport GetImports(this IImportsOperations operations, string collectionName, string workspaceId)
            {
            ...
            /// </param>
            public static async Task<ODataResponseListImport> GetImportsAsync(this IImportsOperations operations, string collectionName, string workspaceId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static Import PostImport(this IImportsOperations operations, string collectionName, string workspaceId, string datasetDisplayName, ImportInfo importInfo, string nameConflict = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Import> PostImportAsync(this IImportsOperations operations, string collectionName, string workspaceId, string datasetDisplayName, ImportInfo importInfo, string nameConflict = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The import id
            /// </param>
            public static Import GetImportById(this IImportsOperations operations, string collectionName, string workspaceId, string importId)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Import> GetImportByIdAsync(this IImportsOperations operations, string collectionName, string workspaceId, string importId, CancellationToken cancellationToken = default(CancellationToken))
            {
