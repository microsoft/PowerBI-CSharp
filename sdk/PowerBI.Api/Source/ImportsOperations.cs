...
namespace Microsoft.PowerBI.Api.V1
{
    ...
    /// </summary>
    internal partial class ImportsOperations : IServiceOperations<PowerBIClient>, IImportsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ImportsOperations(PowerBIClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ODataResponseListImport>> GetImportsWithHttpMessagesAsync(string collectionName, string workspaceId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ODataResponseListImport>();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Import>> GetImportByIdWithHttpMessagesAsync(string collectionName, string workspaceId, string importId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (collectionName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "collectionName");
