namespace Microsoft.PowerBI.Api.V2
{
    ...
    public static partial class ImportsExtensions
    {
        ...
        /// </param>
        public static Import PostImport(this IImports operations, string groupId, string datasetDisplayName, ImportInfo importInfo, string nameConflict = default(string), bool? skipReport = default(bool?))
        {
        ...
        /// The cancellation token.
        /// </param>
        public static async Task<Import> PostImportAsync(this IImports operations, string groupId, string datasetDisplayName, ImportInfo importInfo, string nameConflict = default(string), bool? skipReport = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// Determines whether to skip report import, if specified value must be 'true'. Only supported for PBIX files.
        /// </param>
        public static Import PostImportWithFile(this IImports operations, string groupId, Stream fileStream, string datasetDisplayName = default(string), string nameConflict = default(string), bool? skipReport = default(bool?))
        {
            return Task.Factory.StartNew(s => ((IImports)s).PostImportFileWithHttpMessage(groupId, fileStream, datasetDisplayName, nameConflict, skipReport), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult().Body;
        }
        ...
        /// The cancellation token.
        /// </param>
        public static async Task<Import> PostImportWithFileAsync(this IImports operations, string groupId, Stream fileStream, string datasetDisplayName = default(string), string nameConflict = default(string), bool? skipReport = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
