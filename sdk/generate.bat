...
AutoRest.exe -CodeGenerator CSharp -Modeler Swagger -Input swagger.json -Namespace Microsoft.PowerBI.Api.Beta -output PowerBI.Api\Source\Beta -name PowerBIClient -AddCredentials
popd
pause